...
I’m currently a research intern focusing on mathematical and general reasoning research at <img src="../images/longcat.svg" alt="icon" style="height:25px; vertical-align:middle;"> [**<img src="../images/longcat.svg" alt="icon" style="height:25px; vertical-align:middle;"> Meituan LongCat Team**](https://github.com/meituan-longcat). Previously, I held research intern positions at the Baidu Ernie Team and X-Humanoid LLM Team. 
